...
class TestAccount(unittest.TestCase):
    ...
    def test_save_multiple_account(self):
            ...
            test_account = Account('Brian', 'Mutuma', 'brian@yahoo.com', '0700000006', 'abc1234') # new account
    ...
    def test_delete_account(self):
            ...
            '''
            self.new_account.save_account()
            test_account = Account('Brian', 'Mutuma', 'brian@yahoo.com', '0700000006', 'abc1234') # account
            test_account.save_account()
